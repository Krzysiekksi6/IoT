...
- [Visual Studio Code 12](https://code.visualstudio.com/)
...
- [@react-native-async-storage/async-storage](https://react-native-async-storage.github.io/async-storage/) as storage of data.
